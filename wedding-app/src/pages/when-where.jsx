...
export const WhenWhere = () => (
  <Wrapper page="when">
    ...
    <p style={{ paddingLeft: 20 }}>
      Kuilima Estates East #42
      57-77 Lalo Kuilima Pl
      Kahuku , HI 96731</p>
    ...
    <p>Be at the lobby of Turtle Bay Resort at <time>3pm</time> for shuttles to the venue. The ceremony will start at <time>4pm</time>. The event will end at <time>9pm</time> with shuttles to return you back to Turtle Bay for further salubriations at the hotel bar.</p>
