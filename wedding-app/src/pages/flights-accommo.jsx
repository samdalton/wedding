...
export const Flights = ({ user }) => (
  <section>
    ...
    <h2>Accomodation</h2>
    <p>
      We have block pricing avaialable at the <a href={process.env.REACT_APP_TURTLE_BAY_URL}target="blank" rel="noopener noreferrer">Turtle Bay Resort</a>. The price is $279/night and the resort fee will be covered by us. While a bit pricer than airbnbs around, it will be the pickup location for the wedding shuttles and other social gatherings such as dinner the night before, so you'll be at the heart of the action.
    </p>
    <p>
      There are also plenty of AirBnB houses on the North Shore that are close to the venue. See availability <a href="https://www.airbnb.com/s/North-Shore-Oahu-Hawaii--Kahuku--HI--United-States/homes?refinement_path=%2Ffor_you&allow_override%5B%5D=&ne_lat=21.727897864222932&ne_lng=-157.95872054797792&sw_lat=21.54162203284362&sw_lng=-158.11252914172792&zoom=12&search_by_map=true&checkin=2018-10-02&checkout=2018-10-07&s_tag=dLSBOgNt" target="blank" rel="noopener noreferrer">on AirBnB</a>.
    </p>
  </section>
);
