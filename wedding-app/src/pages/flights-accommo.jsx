...
export const Flights = () => (
  <Wrapper page="flights">
    ...
    <h2>Accomodation</h2>
    <p>
      We have block pricing available at the <a href={process.env.REACT_APP_TURTLE_BAY_URL}target="blank" rel="noopener noreferrer">Turtle Bay Resort</a>. The price is $279/night and the resort fee will be covered by us. While a bit pricer than airbnbs around, it will be the pickup location for the wedding shuttles and other social gatherings such as dinner the night before, so you'll be at the heart of the action.
    </p>
    <p>
